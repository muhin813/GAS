...
class AccountController extends Controller
{
    ...
    public function jobWiseProfitability(Request $request)
    {
        try{
            ...
            $sales = $sales->whereIn('sales.status',['active']);
            $sales = $sales->paginate(50);
            return view('account.job_wise_profitability_index',compact('sales_types','sales'));
        }
        catch(\Exception $e){
            return redirect('error_404');
        }
    ...
    public function jobWiseProfitabilityCreate(Request $request)
    {
        try{
            ...
            return view('account.job_wise_profitability_create',compact('jobs','customers','service_categories','items'));
        }
        catch(\Exception $e){
            return redirect('error_404');
        }
    ...
    public function jobWiseProfitabilityEdit(Request $request)
    {
        try{
            $jobs = Job::whereIn('status',['active'])->get();
            $customers = Customer::where('status','active')->get();
            ...
            $sale = Sale::with('details')->select('sales.*')
                ...
                ->first();
            return view('account.job_wise_profitability_edit',compact('jobs','customers','service_categories','items','sale'));
        }
        catch(\Exception $e){
            return redirect('error_404');
        }
    ...
    public function jobWiseProfitabilityUpdate(Request $request)
    {
        try{
            $user = Auth::user();
    ...
    public function jobWiseProfitabilityDelete(Request $request)
    {
        try{
            $user = Auth::user();
