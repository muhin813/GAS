...
@section('title', 'Create Service Booking')
@section('content')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="vehicle_credential_id" id="vehicle_credential_id" class="form-control">
                                                        ...
                                                        @foreach($vehicle_credentials as $vehicle)
                                                            <option value="{{$vehicle->id}}" >{{$vehicle->name.'-'.$vehicle->model.'-'.$vehicle->registration_number}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        $(document).on("submit", "#service_booking_form", function(event) {
            ...
            if (validate == "") {
                ...
                var url = "{{ url('service_bookings/store') }}";
