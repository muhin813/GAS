                            ...
                            <div class="col-md-12">
                                <div class="page-top-header">
                                    ...
                                    <div class="portlet-body patients-info">
                                        <a href="{{url('items/create')}}" class="btn btn-primary"><i class="icon-plus"></i>&nbsp; Add Item</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet light ">
                                    ...
                                    <div class="portlet-body">
                                        <div class="row">
                                            <table id="item_table" class="table table-striped table-bordered table-hover data-table focus-table">
                                                    <thead>
                                                    <tr>
...
@section('js')
    <script>
        function delete_item(id){
            $(".warning_message").text('Are you sure you delete this item? This can not be undone.');
            $("#warning_modal").modal('show');
            $( "#warning_ok" ).on('click',function() {
                show_loader();
                var url = "{{ url('items/delete') }}";
                $.ajax({
                    type: "POST",
                    url: url,
