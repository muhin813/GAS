...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <form  id="bank_form" method="post" action="" enctype="multipart/form-data">
                        {{csrf_field()}}
...
@section('js')
    ...
    <script>
        ...
        $(document).on("submit", "#bank_form", function(event) {
            ...
            if (validate == "") {
                var formData = new FormData($("#bank_form")[0]);
                var url = "{{ url('bank_branches/store') }}";
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.status == 200) {
                            ...
                            setTimeout(function(){
                                window.location.href="{{url('bank_branches')}}";
                            },1000)
                        } else {
