                                ...
                                <div class="portlet light ">
                                    <div class="portlet-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="customer_registration_number" id="customer_registration_number" class="form-control">
                                                        ...
                                                        @foreach($customers as $customer)
                                                            <option value="{{$customer->registration_number}}">{{$customer->registration_number}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6" id="service_category_area">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6" id="service_type_area">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6" id="service_amount_area">
                                                <div class="form-group">
                                                    <label for=""><b>Service Amount</b></label>
                                                    <div>
                                                        <input type="number" class="form-control" name="service_amount" id="service_amount" value="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6" id="discount_area">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="number" class="form-control" name="vat" id="vat" value="">
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="col-md-12" id="items_area" style="display:none">
                                                <div class="row single_item" style="border: 1px solid;padding: 10px; margin:5px">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control Quantity" name="product_quantities[]" id="product_quantities" value="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for=""><b>Unit Price</b></label>
                                                            <input type="number" class="form-control UnitPrice" name="unit_prices[]" id="unit_prices" value="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for=""><b>Discount</b></label>
                                                            <input type="number" class="form-control Discount" name="discounts[]" id="discounts" value="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6" id="add_item_btn" style="display:none">
