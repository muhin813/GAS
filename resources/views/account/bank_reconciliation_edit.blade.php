            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <form  id="bank_reconciliation_form" method="post" action="" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <input type="hidden" name="id" value="{{$bank_reconciliation->id}}">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="year" id="year" class="form-control">
                                                        @for($year=2023; $year>=2020; $year--)
                                                            <option value="{{$year}}" @if($bank_reconciliation->year == $year) selected @endif>{{$year}}</option>
                                                        @endfor
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="month" id="month" class="form-control">
                                                        ...
                                                        @foreach($months as $key=>$month)
                                                            <option value="{{($key+1)}}" @if($bank_reconciliation->month == $key+1) selected @endif>{{$month}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="bank_id" id="bank_id" class="form-control">
                                                        ...
                                                        @foreach($banks as $bank)
                                                            <option value="{{$bank->id}}" @if($bank_reconciliation->bank_id == $bank->id) selected @endif>{{$bank->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="account_id" id="account_id" class="form-control">
                                                        ...
                                                        @foreach($bank_accounts as $bank_account)
                                                            <option value="{{$bank_account->id}}" @if($bank_reconciliation->account_id == $bank_account->id) selected @endif>{{$bank_account->account_number}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="bank_statement_closing_balance" id="bank_statement_closing_balance" value="{{$bank_reconciliation->bank_statement_closing_balance}}" >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="outstanding_cheque_amount" id="outstanding_cheque_amount" value="{{$bank_reconciliation->outstanding_cheque_amount}}" readonly >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12" id="outstanding_deposit_area" style="border: 1px solid;padding: 10px; margin:5px">
                                                <?php
                                                $outstanding_deposits = json_decode($bank_reconciliation->outstanding_deposits, true);
                                                foreach($outstanding_deposits as $key=>$out_deposit){
                                                ?>
                                                <div class="row outstanding_deposit">
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for=""><b>Date</b></label>
                                                            <input type="text" class="form-control datepicker outstandingDepositeDate" name="outstanding_deposit[{{$key}}][date]" id="outstanding_deposit_date" value="{{$out_deposit['date']}}" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for=""><b>Nature Of Deposit</b></label>
                                                            <input type="text" class="form-control natureOfDeposite" name="outstanding_deposit[{{$key}}][nature]" id="nature_of_deposite" value="{{$out_deposit['nature']}}" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for=""><b>Amount</b></label>
                                                            <input type="number" class="form-control outstandingDepositAmount" name="outstanding_deposit[{{$key}}][amount]" id="amount" value="{{$out_deposit['amount']}}" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for=""><b>Narration</b></label>
                                                            <input type="text" class="form-control outstandingDepositeNarration" name="outstanding_deposit[{{$key}}][narration]" id="narration" value="{{$out_deposit['narration']}}" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        @if($key==0)
                                                        ...
                                                        @else
                                                            <button type="button" title="Remove outstanding deposit" class="btn btn-danger remove_outstanding_deposit_button">Remove</button>
                                                        @endif
                                                    </div>
                                                </div>
                                                <?php } ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="total_outstanding_deposit_amount" id="total_outstanding_deposit_amount" value="{{$bank_reconciliation->outstanding_deposit_amount}}" readonly >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12" id="other_payment_area" style="border: 1px solid;padding: 10px; margin:5px">
                                                <?php
                                                $other_payments = json_decode($bank_reconciliation->other_payments, true);
                                                ...
                                                <div class="row other_payment">
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for=""><b>Date</b></label>
                                                            <input type="text" class="form-control datepicker otherPaymentDate" name="other_payment[{{$key}}][date]" id="other_payment_date" value="{{$other_payment['date']}}" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for=""><b>Nature of Adjustment</b></label>
                                                            <input type="text" class="form-control otherPaymentNatureOfAdjustment" name="other_payment[{{$key}}][nature_of_adjustment]" id="other_payment_nature_of_adjustment" value="{{$other_payment['nature_of_adjustment']}}" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for=""><b>Amount</b></label>
                                                            <input type="number" class="form-control otherPaymentAmount" name="other_payment[{{$key}}][amount]" id="other_payment_amount" value="{{$other_payment['amount']}}" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for=""><b>Narration</b></label>
                                                            <input type="text" class="form-control otherPaymentNarration" name="other_payment[{{$key}}][narration]" id="other_payment_narration" value="{{$other_payment['narration']}}" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        @if($key==0)
                                                        ...
                                                        @else
                                                            <button type="button" title="Remove other payment" class="btn btn-danger remove_other_payment_button">Remove</button>
                                                        @endif
                                                    </div>
                                                </div>
                                                <?php } ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="total_other_payment_amount" id="total_other_payment_amount" value="{{$bank_reconciliation->other_payment_amount}}" readonly >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12" id="other_deposit_area" style="border: 1px solid;padding: 10px; margin:5px">
                                                <?php
                                                $other_deposits = json_decode($bank_reconciliation->other_deposits, true);
                                                foreach($other_deposits as $key=>$other_deposit){
                                                ?>
                                                <div class="row other_deposit">
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for=""><b>Date</b></label>
                                                            <input type="text" class="form-control datepicker otherDepositDate" name="other_deposit[{{$key}}][date]" id="other_deposit_date" value="{{$other_deposit['date']}}" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for=""><b>Nature of Adjustment</b></label>
                                                            <input type="text" class="form-control otherDepositNatureOfAdjustment" name="other_deposit[{{$key}}][nature_of_adjustment]" id="other_deposit_nature_of_adjustment" value="{{$other_deposit['nature_of_adjustment']}}" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for=""><b>Amount</b></label>
                                                            <input type="number" class="form-control otherDepositAmount" name="other_deposit[{{$key}}][amount]" id="other_deposit_amount" value="{{$other_deposit['amount']}}" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for=""><b>Narration</b></label>
                                                            <input type="text" class="form-control otherDepositNarration" name="other_deposit[{{$key}}][narration]" id="other_deposit_narration" value="{{$other_deposit['narration']}}" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        @if($key==0)
                                                        ...
                                                        @else
                                                            <button type="button" title="Remove other deposit" class="btn btn-danger remove_other_deposit_button">Remove</button>
                                                        @endif
                                                    </div>
                                                </div>
                                                <?php } ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="total_other_deposit_amount" id="total_other_deposit_amount" value="{{$bank_reconciliation->other_deposit_amount}}" readonly >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for=""><b>Closing Balance Bank Book</b></label>
                                                    <input type="number" class="form-control" name="closing_balance_bank_book" id="closing_balance_bank_book" value="{{$bank_reconciliation->closing_balance_bank_book}}" >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for=""><b>Variance</b></label>
                                                    <input type="number" class="form-control" name="opening_variance" id="opening_variance" value="{{$bank_reconciliation->opening_variance}}" >
                                                </div>
                                            </div>
                                        </div>
...
@section('js')
    ...
    <script>
        ...
        function populate_outstanding_cheques(){
            var outstanding_cheques = '{{$bank_reconciliation->outstanding_cheques}}';
            outstanding_cheques = outstanding_cheques.split(',');
            var month = $('#month').val();
            var year = $('#year').val();
                ...
                success: function(data) {
                    ...
                    if (data.status == 200) {
                        ...
                        $.each(data.bank_books, function( index, b_book ) {
                            options += '<option value="'+b_book.cheque_number+'#'+b_book.amount+'"';
                            if(jQuery.inArray(b_book.cheque_number+'#'+b_book.amount, outstanding_cheques) !== -1){
                                options += ' selected ';
                            }
        ...
        $(document).on("submit", "#bank_reconciliation_form", function(event) {
            ...
            if (validate == "") {
                ...
                var url = "{{ url('bank_reconciliations/update') }}";
