        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{url('stock_issues')}}">Stock Issue</a>
                        <i class=""></i>
                    </li>
                    <li>
                        <span>Create</span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control datepicker" name="date_of_issue" id="date_of_issue" value="" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for=""><b>Quantity Left for Issue</b></label>
                                                    <div>
    ...
    <script>
        ...
        $(document).on("submit", "#stock_issue_form", function(event) {
            ...
            if (validate == "") {
                ...
                var url = "{{ url('stock_issues/store') }}";
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        hide_loader();
                        if (data.status == 200) {
                            $('#stock_issue_form')[0].reset();

                            $("#success_message").show();
                            $("#error_message").hide();
                            $("#success_message").html(data.reason);
                            setTimeout(function(){
                                window.location.href="{{url('stock_issues')}}";
                            },1000)
                        } else {
