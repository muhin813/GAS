                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="vehicle_name" id="vehicle_name" value="{{$package->vehicle_name}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control datepicker" name="package_validity" id="package_validity" value="{{date('m/d/Y',strtotime($package->package_validity))}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for=""><b>Conditions</b></label>
                                                    <input type="text" class="form-control" name="conditions" id="conditions" value="{{$package->conditions}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12" id="package_details_area">
                                                <?php foreach($package->details as $key=>$p_details){
                                                    $sub_details = $p_details->sub_details;
                                                    ?>
                                                <div class="row package_details" style="border: 1px solid;padding: 10px; margin:5px">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for=""><b>Package Details</b></label>
                                                            <input type="text" class="form-control PackageDetailsName" name="package_detail_name[]" id="package_detail_name" value="{{$p_details->description}}">
                                                            <input type="hidden" class="package_detail_index" name="package_detail_index[]" id="package_detail_index" value="{{$key}}">
                                                        </div>
                                                    </div>
                                                    @if($key>0)
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for=""></label>
                                                                <button type="button" title="Remove Detail" class="btn btn-danger remove_details_button"><i class="icon-trash"></i></button>
                                                        </div>
                                                    </div>
                                                    @endif
                                                    <div class="col-md-12 package_sub_details_area">
                                                        ...
                                                        if(!empty($sub_details)){
                                                            foreach($sub_details as $key2=>$sub_detail){
                                                        ?>
                                                            <div class="row package_sub_details" style="padding: 10px; margin:5px">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <input type="text" class="form-control vehicleName" name="package_sub_detail_name[{{$key}}][]" id="package_sub_detail_name" value="{{$sub_detail->description}}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for=""></label>
                                                                        @if($key2>0)
                                                                        <button type="button" title="Remove Sub Detail" class="btn btn-danger remove_sub_details_button"><i class="icon-trash"></i></button>
                                                                        @endif
                                                                        @if($key2==0)
                                                                        <button type="button" title="Add Sub Detail" class="btn btn-success add_sub_details_button"><i class="icon-plus"></i></button>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <?php
                                                            }//end sub details foreach
                                                        }//end sub details if
                                                        else{ ?>
                                                        <div class="row package_sub_details" style="border: 1px solid;padding: 10px; margin:5px">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control vehicleName" name="package_sub_detail_name[{{$key}}][]" id="package_sub_detail_name" value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12" id="package_benefits_area">
                                                ...
                                                if(!empty($package->benefits)){
                                                    foreach($package->benefits as $key=>$benefits){ ?>
                                                    <div class="row package_benefits" style="padding: 10px; margin:5px">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control PackageBenefit" name="package_benefits[]" id="package_benefits" value="{{$benefits->description}}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for=""></label>
                                                                @if($key>0)
                                                                    <button type="button" title="Remove Package Benefits" class="btn btn-danger remove_benefits_button"><i class="icon-trash"></i></button>
                                                                @endif
                                                                @if($key==0)
                                                ...
                                                <?php } // end benefit foreach
                                                } // end benefit if
                                                else{ ?>
                                                <div class="row package_benefits" style="border: 1px solid;padding: 10px; margin:5px">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
